export class CacheManager {
    constructor() {
        this.cacheKey = 'community-notes-elo-cache';
        this.cacheExpiryKey = 'community-notes-elo-cache-expiry';
        this.cacheHours = 2; // Cache for 2 hours
    }
    saveToCache(tweets, daysBack) {
        try {
            const cacheData = {
                tweets,
                daysBack,
